...
#define SEG_GPU_DVFS_VOLT7		(72500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT8		(70000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT9		(67500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT10		(65000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT11		(62500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT12		(60000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT13		(57500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT14		(55000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT15		(52500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT16		(50000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT17		(47500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT18		(45000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT19		(42500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT20		(40000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT21		(37500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT22		(35000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT23		(32500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT24		(30000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT25		(27500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT26		(25000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT27		(22500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT28		(20000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT29		(17500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT30		(15000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT31		(12500)		/* mV x 100 */

#define SEG_GPU_DVFS_VSRAM0		(102500)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM1		(100000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM2		(97500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM3		(95000)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM4		(92500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM5		(90000)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM6		(87500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM7		(85000)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM8		(82500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM9		(80000)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM10	(77500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM11	(75000)		/* mV x 100 */

#define FIXED_VSRAM_VOLT			(80000)		/* mV x 100 */
